...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 1360 (incl. 768 user, 540 helpers, 12 vtables, 40 lits); src size 0
; assembly: 943 lines; density: 153.6 bytes/stmt; (5 stmts)
; total bytes: 230736 (95.1% of 237.0k flash with 11952 free)
...
; start
    ...
    .hex A0A116610B5B59D8 ; hex template hash
    .hex 2AD3C69E6CABEFDB ; program hash
    .short 4   ; num. globals
...
_main___P1_locals:
    ...
    mov r7, sp
    str r7, [r6, #4]
    bl OLED::init_terminal
    @stackempty locals
    ldr r0, _ldlit_2      
    mov r7, sp
    str r7, [r6, #4]
    bl OLED::showStringWithNewLine
    @stackempty locals
.ret.1:
    @stackempty locals
_main___P1_end:
